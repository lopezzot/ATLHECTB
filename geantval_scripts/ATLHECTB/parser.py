...
class Test(BaseParser):
	...
	yield getJSON(jobs[0], "chart",
	                        ...
	                        yStatErrorsMinus= [22.57-22.2, 21.89-21.6, 21.78-21.5, 22.6-22.30, 22.32-22.0, 21.46-21.2, 21.57-21.3],
			                yStatErrorsPlus= [22.57-22.2, 21.89-21.6, 21.78-21.5, 22.6-22.30, 22.32-22.0, 21.46-21.2, 21.57-21.3]
			    )
	...
	yield getJSON(jobs[0], "chart",
			                  ...
			                  yStatErrorsPlus= [14.47-13.47,13.89-13.47, 11.85-11.55, 11.52-11.28,11.27-11.06, 0.001, 0.001, 0.001, 0.001, 0.001, 0.001],
	                          yStatErrorsMinus= [14.47-13.47,13.89-13.47, 11.85-11.55, 11.52-11.28,11.27-11.06, 0.001, 0.001, 0.001, 0.001, 0.001, 0.001]
                              )
	...
	yield getJSON(jobs[0], "chart",
			                  ...
			                  yStatErrorsPlus= [0.79-0.777, 0.8095-0.796, 0.816-0.8026,0.833-0.819, 0.84-0.825, 0.844-0.829, 0.854-0.840],
	                          yStatErrorsMinus= [0.79-0.777, 0.8095-0.796, 0.816-0.8026,0.833-0.819, 0.84-0.825, 0.844-0.829, 0.854-0.840]
                              )
