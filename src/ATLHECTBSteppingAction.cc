...
void ATLHECTBSteppingAction::UserSteppingAction(const G4Step* step){
    ...
    //
    auto FindrelX = [module1_halfPhi, module2_halfPhi, module3_halfPhi](G4int modulecpNo, G4double hitPhi){
        G4double module_halfPhi = 0.0;
        if(modulecpNo==101) module_halfPhi = module1_halfPhi;
        else if(modulecpNo==102) module_halfPhi = module2_halfPhi;
        else if(modulecpNo==103) module_halfPhi = module3_halfPhi;
        else { 
